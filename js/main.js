function updateProfileInfo(profileData){
    ...
    photo.alt = "Imagem de Perfil de Gabriel Moreira Kopke Junior"
    ...
    phone.hrc = `tel:${profileData.phone}`

    const email = document.getElementById('profile.email');
    email.innerText = profileData.email
    email.hrc = `hrc:${profileData.email}`
}
...
function updateExperience(profileData){
    ...
    experience.innerHTML += profileData.professionalExperience.map(experience => {
        return `
        <li>
            <h3 class="title">${experience.name} / dio.me</h3>
